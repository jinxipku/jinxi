<div class=" rightpart">
	<span><a href="<?=$baseurl?>display/hall" type="button"
		class="btn btn-primary btn-hg" style="margin-bottom: 10px; width: 127px;">商品大厅
	</a><a href="<?=$baseurl?>display/textbook" type="button"
		class="btn btn-primary btn-hg" style="margin-bottom: 10px; margin-left: 10px; width: 127px;">教材专区
	</a></span> <a href="<?=$baseurl?>item/newpost/type" type="button"
