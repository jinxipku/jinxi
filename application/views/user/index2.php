<div class="row" style="margin-top: 20px; min-height: 800px;">
	<div id="scrollhead1" style="position: absolute; top: 260px;"></div>
	<div class="leftpart2" style="height: 200px;">
	...
	<div class="rightpart2" style="height: 200px;">
		...
		<?php elseif($cur_user['user_id']==$login_user['user_id']):?>
			<a type="button" class="btn btn-sm btn-primary"
				href="<?=$baseurl?>item/newpost/type">发布信息</a>
		<?php else:?>
	...
	<div class="leftpart2">
		...
		<ul class="nav nav-pills nav-stacked"
			style="position: relative; float: left; margin-top: 4px; width: 200px;">
			<li class="active"><a href="#thisrec" data-toggle="tab"
				onclick="showuserpage(0,<?=$cur_user['user_id']?>,1,0)">本站推荐商品</a></li>
			<li><a href="#bbsrec" data-toggle="tab"
				onclick="showuserpage(1,<?=$cur_user['user_id']?>,1,0)">BBS推荐商品</a></li>
			<li><a href="#mypost" data-toggle="tab"
				onclick="showuserpage(2,<?=$cur_user['user_id']?>,1,0)">我自己的商品</a></li>
			<li><a href="#myfocus" data-toggle="tab"
				onclick="showuserpage(3,<?=$cur_user['user_id']?>,1,0)">我收藏的商品</a></li>
			<li><a href="#mylove" data-toggle="tab"
				onclick="showuserpage(4,<?=$cur_user['user_id']?>,1,0)">我关注的用户</a></li>
			<li><a id="mycommlink" href="#mycomm" data-toggle="tab"
				onclick="showuserpage(5,<?=$cur_user['user_id']?>,1,0)">我的所有评论</a></li>
			<li><a href="#mymess" data-toggle="tab"
				onclick="showuserpage(8,<?=$cur_user['user_id']?>,1,0)">我的所有消息</a></li>
		</ul>
		<?php else:?>
		<ul class="nav nav-pills nav-stacked"
			style="position: relative; float: left; margin-top: 4px; width: 200px;">
	...
	<div class="rightpart2 panel panel-default">
		<?php if(isset($login_user)&&$cur_user['user_id']==$login_user['user_id']):?>
